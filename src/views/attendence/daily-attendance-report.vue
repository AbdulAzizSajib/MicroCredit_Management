          ...
          <table class="w-full min-w-max">
            ...
            <thead>
              <tr class="bg-gradient-to-r from-violet-600 to-purple-500 text-white">
                <th class="px-3 py-3 text-left text-xs rounded-s font-semibold border-r border-slate-600 whitespace-nowrap">
                  Department</th>
                <th class="px-3 py-3 text-left text-xs font-semibold border-r border-slate-600 whitespace-nowrap">Staff
                  ID</th>
                <th class="px-3 py-3 text-left text-xs font-semibold border-r border-slate-600 whitespace-nowrap">Emp
                  Name</th>
                <th class="px-3 py-3 text-left text-xs font-semibold border-r border-slate-600 whitespace-nowrap">
                  Designation</th>
                <th class="px-3 py-3 text-left text-xs font-semibold border-r border-slate-600 whitespace-nowrap">Card
                  Number</th>
                <th class="px-3 py-3 text-left text-xs font-semibold border-r border-slate-600 whitespace-nowrap">
                  Employee Type</th>
                <th class="px-3 py-3 text-left text-xs font-semibold border-r border-slate-600 whitespace-nowrap">
                ...
                <th class="px-3 py-3 text-left text-xs font-semibold border-r border-slate-600 whitespace-nowrap">Date
                </th>
                ...
                <th class="px-3 py-3 text-left text-xs font-semibold border-r border-slate-600 whitespace-nowrap">Out
                  Time</th>
                <th class="px-3 py-3 text-left text-xs font-semibold border-r border-slate-600 whitespace-nowrap">Status
                </th>
                <th class="px-3 py-3 text-left text-xs font-semibold border-r border-slate-600 whitespace-nowrap">Actual
                  Hour</th>
                <th class="px-3 py-3 text-left text-xs font-semibold border-r border-slate-600 whitespace-nowrap">Leave
                  Hour</th>
                <th class="px-3 py-3 text-left text-xs font-semibold border-r border-slate-600 whitespace-nowrap">Leave
                  Hour</th>
                <th class="px-3 py-3 text-left text-xs font-semibold border-r border-slate-600 whitespace-nowrap">
                ...
                <th class="px-3 py-3 text-left text-xs font-semibold border-r border-slate-600 whitespace-nowrap">
                  Short/Excess</th>
                <th class="px-3 py-3 text-left text-xs rounded-e font-semibold whitespace-nowrap">OT (Hour)</th>
              </tr>
            </thead>
            ...
            <tbody>
              <tr v-for="(employee, index) in filteredEmployees" :key="employee.id"
                ...
                <td class="px-3 py-2 text-xs text-gray-700 border-r border-gray-200">{{ employee.staffId }}</td>
                ...
                <td class="px-3 py-2 text-xs text-gray-700 border-r border-gray-200">{{ employee.employeeType }}</td>
                <td class="px-3 py-2 text-xs text-gray-700 border-r border-gray-200">{{ employee.section }}</td>
                <td class="px-3 py-2 text-xs text-gray-700 border-r border-gray-200">{{ employee.subSection }}</td>
                ...
                <td class="px-3 py-2 text-xs text-gray-700 border-r border-gray-200">
                  <span class="px-2 py-1 rounded text-xs font-medium"
                    :class="employee.status === 'A' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'">
                    {{ employee.status }}
                  </span>
                </td>
                <td class="px-3 py-2 text-xs text-gray-700 border-r border-gray-200">{{ employee.actualHour }}</td>
                <td class="px-3 py-2 text-xs text-gray-700 border-r border-gray-200">{{ employee.leaveHour1 }}</td>
                <td class="px-3 py-2 text-xs text-gray-700 border-r border-gray-200">{{ employee.leaveHour2 }}</td>
                ...
                <td class="px-3 py-2 text-xs text-gray-700">{{ employee.otHour }}</td>
              </tr>
            </tbody>
          </table>
        </div>
