    ...
    <div class="w-full max-w-6xl mx-auto p-8">
      ...
      <div class="text-center mb-6">
        <h3 class="text-lg font-semibold inline-block px-4 py-1">
          Statements of Receipts & Payments as on 30th June, 2024.
        </h3>
      </div>
      ...
      <table class="w-full border-collapse">
        ...
        <tbody>
          ...
          <!-- <tr>
            ...
            <td class="px-4 py-2 font-bold underline" colspan="4">Property & Assets :</td>
          </tr> -->

          <!-- A. Non-Current Assets -->
          <tr v-for="(data, index) in voucherData" :key="index">
            <td class="px-4 py-2 font-bold">{{ data?.ReportCode }}</td>
...
const formData = ref({
  DateFrom: "oct 1 2025",
  DateTo: "oct 31 2025",
  YearOpeningDate: "jul 1 2025",
  BalanceDate: "2025_2026",
});
...
const fetchVouchers = async () => {
  try {
    ...
    console.log("Receipt Datat", voucherData.value);
    loading.value = false;
  } catch (err) {
